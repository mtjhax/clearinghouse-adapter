...
SAMPLE_IMPORT_MAPPING = {
  ...
  customer_external_id:               { key_values: [ :customer_identifiers, ',', :customer_external_id ]},
  customer_load_time:                 { and: [ :customer_boarding_time, :customer_deboarding_time ]},
  ...
  pickup_jurisdiction:                [ :pick_up_location_attributes, :jurisdiction ],
  ...
  drop_off_telephone:                 { prepend: [[ :drop_off_location_attributes, :phone_number ], ' ' ]},
  ...
  drop_off_jurisdiction:              [ :drop_off_location_attributes, :jurisdiction ],
...
SAMPLE_EXPORT_MAPPING = {
  trip_ticket: {
    ...
    customer_identifiers:               { key_value_merge: [ :customer_external_id, ','] },
    customer_boarding_time:             { or: :customer_load_time },
    customer_deboarding_time:           { or: :customer_load_time },
